...
public class X12Reader {
    ...
    private static final String _X095_ANSI_VERSION = "004010X095A1";
    ...
    static {
        _TYPES.put(FileType.ANSI834_4010_X095, _X095_ANSI_VERSION);
        _TYPES.put(FileType.ANSI834_5010_X220, _X220_ANSI_VERSION);
        _TYPES.put(FileType.ANSI834_5010_X220v2, _X220_ANSI_VERSION);
    }
